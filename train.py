...
from loss import ChiSquareLoss, HistogramLoss
...
def train(model_name,
    ...
    for epoch in range(num_epochs):
        ...
        for org_img, goal_img in train_loader:
            ...
            optimizer.zero_grad()
            out = model(org_img)
            loss1 = criterion(out, goal_img)
            loss2 = criterion1(out, goal_img)
            loss = loss1 + loss2
            loss.backward()
            optimizer.step()
        ...
        if (epoch + 1) % 10 == 0:
            ...
            for val_org_img, val_goal_img in val_loader:
                ...
                val_loss1 = criterion(out, val_goal_img)
                val_loss2 = criterion1(out, val_goal_img)
...
if __name__ == '__main__':
    ...
    train(model_name='film_mask',
          ...
          model_path='checkpoints/film_mask',
          test_image='images/mask.jpg',
          test_path='test/film_mask',
          training_channel='lab')

...
from model import UNet, FilterSimulation,infer,image2block
from PyQt5.QtGui import QColor, QPainter, QFont, QPixmap, QImage
import torch.nn.functional as F

file_path = os.path.dirname(__file__)
# file_path = '/Users/maoyufeng/slash/project/filter4free'
...
class MyMainWindow(QMainWindow):
    ...
    def load_model(self, model_name='UNet', filter_name='FJ-NC', channel=3):
        ...
        model_list = {
            ...
            'FilterSimulation': {'model': FilterSimulation(channel=channel), 'pth': 'best-v4.pth'}
        }
